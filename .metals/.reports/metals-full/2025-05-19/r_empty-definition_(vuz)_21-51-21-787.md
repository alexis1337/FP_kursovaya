error id: file:///C:/Users/Alexis/AppData/Local/Temp/vuz/src/main/scala/functions/ProfessorFunctions.scala:`<none>`.
file:///C:/Users/Alexis/AppData/Local/Temp/vuz/src/main/scala/functions/ProfessorFunctions.scala
empty definition using pc, found symbol in pc: `<none>`.
semanticdb not found

found definition using fallback; symbol faculty
offset: 213
...
def findProfessor(): Unit = {
    ...
    SQLiteDatabase.getAllProfessors() match {
      case Some(professors) =>
        val found = professors.filter(_.f@@aculty == faculty)
        if (found.isEmpty)
